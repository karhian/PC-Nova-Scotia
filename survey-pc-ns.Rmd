...
As for weaknesses in this report, it's with the possibilities of bias. We were not able to sample everyone in a household, rather just the head of it, which may not represent the whole house's political views. And for future work, we may want to diversify our surveys to target different demographics and have questions catered for different age groups.
