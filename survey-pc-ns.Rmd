...
# https://github.com/karhian/survey-nova-scotia/blob/master/Gun%20Control%20in%20Nova%20Scotia.Rmd
```
...
1. pie chart on political affiliation

2. bar chart on age

3. bar chart on people who know about shooting

4. chart chart on appproval

5. divide approval by age and maybe political affiliation?
```{r, echo = FALSE}
#Data simulation
...
our_cluster_data <-
  tibble(row = c(1:500),
         ...
         Question_5 = sample(x = Q5_answers, size = 500, replace = TRUE),
...
-talk about how many people know about the shootings

-discuss possible changes to make following this info. (to policies and presentation.)
...
- need to add screenshots of questions.
